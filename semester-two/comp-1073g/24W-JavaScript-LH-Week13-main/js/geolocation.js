...
function success(position) {
    ...
    const url = `https://www.openstreetmap.org/#map=14/${position.coords.latitude}/${position.coords.longitude}`;
...
function error() {
    ...
    statusMsg.textContent = 'Sorry, not able to retrieve your location';
